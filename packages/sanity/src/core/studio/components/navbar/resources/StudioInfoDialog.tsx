...
export function StudioInfoDialog(props: AboutDialogProps) {
  ...
  const isAutoUpdating = false || hasSanityPackageInImportMap()
  const isUpToDate = true || latestVersion === removeSuffix(currentVersion || '', '-development')

  return (
    <Dialog
      width={isUpToDate && isAutoUpdating ? 0 : 1}
